if(document.getElementById('cancelarbtn')) document.getElementById('cancelarbtn').onclick=function(){
	window.history.back();
}
...
//            console.log(data);
//            if (data.result) {
//                alert("Ha establecido una paga a "+papi.nombre+" de "+papi.cant+"€ "+papi.frecuencia+".")
