...
<body>
    ...
    <section>
        <div><a href="#">Saldo</a></div>
        <div id="realizarpago"><a href="#">Realizar Pago</a></div>
        <div id="pumbanking"><a href="#">Pumbanking</a></div>
        <div id="transferencias"><a href="#">Transferencia</a></div>
