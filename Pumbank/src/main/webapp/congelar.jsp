				...
				<div id="congelar">
					...
					<div>
						<form action="" method="POST" id="congelarniño" novalidate>
							<div>
								<div id="nombre_niño_error" class="error esconder">*Debe
									el nombre del usuario al que desea congelar la cuenta.</div>
							</div>

							<div>
								<label for="fecha_inicio">Desde</label> <input id="fecha_inicio"
									type="date" class="noflechas" name="fecha_inicio" required>
								<div id="fecha_inicio_error" class="error esconder">*Debe
									introducir una fecha de inicio.</div>
							</div>

							<div>
								<label for="fecha_fin">Hasta</label> <input id="fecha_fin"
									type="date" class="noflechas" name="fecha_fin" required>
								<div id="fecha_fin_error" class="error esconder">*Debe
									introducir una fecha de inicio.</div>
							</div>
